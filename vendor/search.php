            ...
            <div class ="d-flex flex-column vh-100 justify-content">
                ...
                <div class="d-flex flex-row">
                    <?php
                        ...
                        $sql_obj=mysqli_query($conn,"select * from products where vendor_id=$_SESSION[userid] and (product_name like '%$pro_name%' or category like '%$pro_name%')");
