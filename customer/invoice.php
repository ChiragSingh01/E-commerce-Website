                ...
                <div class ="d-flex flex-column vh-100 justify-content">
                    <div class="d-flex flex-row">
                        <?php                     
                            ...
                            $sql_obj=mysqli_query($conn,"select * from products,address,invoice where address.userId=$_SESSION[userid] and invoice.userId=$_SESSION[userid] and invoice.proId=product_ID");
