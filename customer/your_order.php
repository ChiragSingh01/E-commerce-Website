                ...
                <div class ="d-flex flex-column vh-100 justify-content">
                    <div class="d-flex flex-row">
                        <?php                     
                            ...
                            $sql_obj=mysqli_query($conn,"select * from products,yourorder,invoice where product_ID=pro_id and yourorder.user_id=$_SESSION[userid] and proId=product_ID and pro_id=proId and userId=$_SESSION[userid]");
                                    ...
                                    <div>
                                        <div class='pdt-card'>
                                            ...
                                            <div style='display: flex; justify-content: center; align-items: center; width: 100%'>
                                                <a href='cancel_order.php?order_id=$row[order_id]&invoiceid=$row[invoiceId]' style='text-decoration: none;'>
                                                    <button class='button1' style=' background-color: red; '>Cancel Order</button>
                                                <a>
                                            </div> 
                                        </div>                                    
                                    </div>
