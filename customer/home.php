        ...
        <div class = "d-flex flex-column vh-100">
            <div class = "upper_bar d-flex flex-row justify-content">
                ...
                <form action="search.php" method="post" class="d-flex flex-row align-items-center">
                    <input class="form-control shadow-none"type="text" name="search" placeholder="Search for products" style=" background-color: #dfdfdf; border: none; margin-left: 20px; margin-top: 15px; width: 500px; shadow: none;">
            ...
            <div class ="d-flex flex-column vh-100 justify-content">
                <div class="d-flex flex-row">
                    <?php
                        ...
                        $sql_obj=mysqli_query($conn,"select * from products where status = 'Active'");
